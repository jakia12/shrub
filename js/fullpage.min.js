...
!function(n, t) {
    ...
    function $(n, t, e) {
        var i;
        e = void 0 === e ? {} : e,
        "function" == typeof o.CustomEvent ? i = new CustomEvent(t,{
            detail: e
    ...
    String.prototype.padStart || (String.prototype.padStart = function(n, t) {
        return n >>= 0,
        t = String(void 0 !== t ? t : " "),
        this.length > n ? String(this) : ((n -= this.length) > t.length && (t += Array.apply(null, Array(n)).map((function() {
            return t
        }
        )).join("")),
    ...
    var vn = {
        ...
        D: function(n, t) {
            var e = this;
            return "object" !== sn(this.L[n]) && (this.L[n] = []),
            this.L[n].push(t),
            function() {
    ...
    function xt() {
        if (!Tt().anchors.length) {
            ...
            n.length && n.length === p(Tt().sectionSelector, mt).length && (wt = !0,
    ...
    function zt(n) {
        var t, e, i = Tt();
        return i.autoScrolling && !i.scrollBar ? (t = -n,
        e = p(Hn)[0]) : (t = n,
        e = window),
        {
            options: t,
    ...
    function Yt(n, t, e, i) {
        ...
        _t = function(f) {
            ...
            if (dn.q) {
                ...
                s <= e && Ct(n, v),
                s < e ? window.requestAnimationFrame(_t) : void 0 === i || l || (i(),
                hn({
                    q: !1
                }),
                l = !0)
    ...
    function Xt(n, t) {
        ...
        return $(St(), n, e),
        !1 !== Tt()[n].apply(e[Object.keys(e)[0]], on(e))
    }
    function Jt(n) {
        var t = Pt(n);
    ...
    function ee() {
        ...
        Kt.className = Kt.className.replace(o, ""),
        L(Kt, "fp-viewing-" + i)
    }
    function ie(n) {
        if (!n)
    ...
    function oe(n, t, e) {
        var i = "";
        Tt().anchors.length && !Tt().lockAnchors && (n ? (null != e && (i = e),
        null == t && (t = n),
        hn({
            K: t
        }),
    ...
    function re(n) {
        if (Tt().recordHistory)
            ...
            o.history.replaceState(void 0, void 0, "#" + n);
        else {
    ...
    function ge() {
        ...
        for (var i = "", o = 0; o < pn().C.length; o++) {
            ...
            i += '<li><a href="#' + encodeURI(u) + '"><span class="fp-sr-only">' + ae(a.index(), "Section") + "</span><span></span></a>";
            var l = Tt().navigationTooltips[a.index()];
            void 0 !== l && "" !== l && (i += '<div class="fp-tooltip fp-' + Tt().navigationPosition + '">' + l + "</div>"),
            i += "</li>"
        }
    ...
    function we(n, t) {
        var e;
        e = n,
        Tt().menu && Tt().menu.length && p(Tt().menu).forEach((function(n) {
            null != n && (D(p(qn, n), Kn),
        ...
        function(n, t) {
            var e = p(Xn)[0];
            Tt().navigation && null != e && "none" !== e.style.display && (D(p(qn, e), Kn),
            L(n ? p('a[href="#' + n + '"]', e) : p("a", p("li", e)[t]), Kn))
        }(n, t)
    }
    le.m = {
        up: !0,
    ...
    function je(n, t, e) {
        ...
        if (null != i) {
            var o, r, a = function(n) {
                ...
                return t > w() ? (o || a) && "bottom" !== a || (i = r) : (o || dn.V && null == T(n)) && (i = r),
                hn({
                    tn: i
                }),
                i
            ...
            if (!(pn().I.item == i && !dn.V || Tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height"))) {
                if (null != u.activeSlide && (o = U(u.activeSlide, "data-anchor"),
                r = A(u.activeSlide, null)),
                !u.localIsResizing) {
                    var l = u.yMovement;
                    if (void 0 !== e && (l = e ? "up" : "down"),
                    u.direction = l,
                    Y(Tt().beforeLeave) && !1 === ke("beforeLeave", u))
                        return;
                    if (Y(Tt().onLeave) && !Xt("onLeave", u))
                        return
                }
                Tt().autoScrolling && Tt().continuousVertical && void 0 !== u.isMovementUp && (!u.isMovementUp && "up" == u.yMovement || u.isMovementUp && "down" == u.yMovement) && (u = function(n) {
                    ...
                    var t = pn().I.item;
                    return n.isMovementUp ? N(t, tn(t, $n)) : I(t, en(t, $n).reverse()),
                ...
                function(n) {
                    ...
                    Tt().css3 && Tt().autoScrolling && !Tt().scrollBar)
                        ...
                        Tt().scrollingSpeed ? (clearTimeout(Me),
    ...
    function Oe(n) {
        ...
        function(n) {
            null != n.mn && (n.isMovementUp ? N(p($n)[0], n.mn) : I(p($n)[pn().C.length - 1], n.mn),
            Vt(pn().I.item.offsetTop),
            function() {
                for (var n = p(nt), t = 0; t < n.length; t++)
                    Ge(n[t], "internal")
    ...
    function Re(n) {
        ...
        k(p(Xn)),
        L(Kt, Wn),
        Y(Tt().afterResponsive) && Tt().afterResponsive.call(St(), n)) : t && (de(Mt().autoScrolling, "internal"),
    ...
    function Ne() {
        Tt().scrollOverflow && !Tt().scrollBar && (Ve.Tn(),
        Ve.Mn())
    }
    function Be() {
        vn.removeListener(gn, Ne),
        q("keyup", Ve.An)
    }
    ...
    var He, We, Ve = {
        ...
        Rn: function() {
            r.activeElement === this.xn && (this.xn.blur(),
            Ve.jn = !1)
        },
        Mn: function() {
        ...
        zn: function(n) {
            ...
            n.addEventListener("wheel", Ve.Dn, {
                passive: !1
            }),
        ...
        Nn: function(n, t) {
            ...
            if (Tt().scrollBar)
                return !0;
            var e = Ve.Pn(t);
            if (!Tt().scrollOverflow || !m(e, at) || m(t, "fp-noscroll") || m(Pt(t), "fp-noscroll"))
                return !0;
            var i = c ? 1 : 0
              , o = e.scrollTop
              , r = "up" === n && o <= 0
              ...
              , u = r || a;
            return u || (this.On = (new Date).getTime()),
            u
        },
        Bn: function() {
        ...
        function(n) {
            ...
            He = t,
            Y(Tt().onScrollOverflow) && Xt("onScrollOverflow", {
                position: t,
                direction: e
            }),
    ...
    function _e(n, t, e) {
        ...
        D(W(t), Kn),
        Qe(),
        l.localIsResizing || (ne(l.prevSlide),
        te(t)),
        function(n) {
            !Tt().loopHorizontal && Tt().controlArrows && (X(p(ht, n.section), 0 !== n.slideIndex),
        ...
        function(n, t, e) {
            ...
            if (i = t.slidesNav,
            o = t.slideIndex,
            Tt().slidesNavigation && null != i && (D(p(qn, i), Kn),
            L(p("a", p("li", i)[o]), Kn)),
            hn({
    ...
    function qe(n) {
        n.localIsResizing || (Y(Tt().afterSlideLoad) && Xt("afterSlideLoad", n),
        hn({
            G: !0
        }),
        Jt(n.destiny),
    ...
    function Qe() {
        ...
        dn.C.map((function(n) {
            ...
            n.ln = Ve.ln(n.item),
            t && (dn.I = n),
            n.slides.length && (n.activeSlide = null,
    ...
    ni.prototype = jt.prototype,
    ni.prototype.constructor = ni;
    var ti, ei = function(n, t) {
        this.parent = t,
        jt.call(this, n, Tt().slideSelector)
    };
    function ii() {
    ...
    function oi(n) {
        ...
        t > 1 && (Tt().controlArrows && function(n) {
            ...
            L(e[0], dt),
            L(e[1], "fp-next"),
            "#fff" !== Tt().controlArrowColor && (y(p(pt, t), {
        ...
        Tt().slidesNavigation && function(n) {
            var t = n.item
              , e = n.slides.length;
            ...
            for (var o = 0; o < e; o++)
                E(J('<li><a href="#"><span class="fp-sr-only">' + ae(o, "Slide", p(Zn, t)[o]) + "</span><span></span></a></li>"), p("ul", i)[0]);
            y(i, {
    ...
    ei.prototype = jt.prototype,
    ei.prototype.constructor = ni;
    var ri = {
        attributes: !1,
        subtree: !0,
        childList: !0,
    ...
    function ui(n) {
        var t = ai();
        (ai() || h(p(Tt().sectionSelector, St())).length !== pn().P) && !dn.on && (Tt().observer && ti && ti.disconnect(),
        Xe(),
        Qe(),
        Tt().anchors = [],
        Z(p(Xn)),
    ...
    vn.D(Sn, (function() {
        var n, t, e;
        Tt().observer && "MutationObserver"in window && p(Hn)[0] && (n = p(Hn)[0],
        t = ri,
    ...
    var li = function() {
        ...
        try {
            ...
            K("testPassive", null, t),
            G("testPassive", null, t)
        } catch (n) {}
        return function() {
            return n
        }
    ...
    var fi, si, vi, di, hi = (vi = (new Date).getTime(),
    di = [],
    {
        Un: function(n) {
    ...
    var wi, bi, yi, Si = (wi = !1,
    bi = {},
    yi = {},
    function(n, t, e) {
        switch (n) {
        case "set":
            bi[t] = (new Date).getTime(),
            yi[t] = e;
            break;
        case "isNewKeyframe":
    ...
    function Ti() {
        ...
        null != n ? je(n, null, !1) : St().scrollHeight < Kt.scrollHeight && Tt().scrollBar && Tt().un && vn.R(Dn)
    }
    function Mi() {
        var n = pn().I.prev();
    ...
    f.moveSectionDown = Ti,
    f.moveSectionUp = Mi;
    var Ai = 0;
    function xi(n) {
        Tt().autoScrolling && (dn.G && (n.pageY < Ai && fe().m.up ? Mi() : n.pageY > Ai && fe().m.down && Ti()),
        Ai = n.pageY)
    }
    function ki(n) {
        if (fe().m[n]) {
    ...
    var ji, Oi, Li, Di, Ei = 0, Ri = 0, Pi = 0, Fi = 0, zi = (o.PointerEvent && (Di = {
        down: "pointerdown",
        move: "pointermove"
    }),
    Di), Ci = {
    ...
    function Wi(n) {
        ...
        l && Ni(n) && Tt().scrollBar && void 0 !== n.touches && (t.y = n.touches[0].pageY,
            ...
            if (dn.G) {
                if (!function(n) {
                    ...
                    if (l || !t && u) {
                        V(n);
                        var c = function(n) {
                            var t, e = n ? "prevPanel" : "nextPanel", i = [], o = Ft((dn.I && dn.I.activeSlide ? dn.I.activeSlide : dn.I)[e]());
                            do {
                ...
                V(n)
        }(n) : !cn() && Tt().keyboardScrolling && i && (ji = n.ctrlKey,
    ...
    function ao(n) {
        ...
        St().addEventListener("mouseup", co)) : (r.addEventListener ? (q("mousewheel", uo, !1),
        q("wheel", uo, !1),
        q("MozMousePixelScroll", uo, !1)) : r.detachEvent("onmousewheel", uo),
        ...
        var t = (new Date).getTime()
          ...
          , i = function(n, t) {
            ...
            if (pn().B) {
                if (e) {
                    var o;
                    if (!(i || Si("isNewKeyframe", "beyondFullpage") && hi._n()))
                        return (o = zt(rn(pn().C).item.offsetTop + rn(pn().C).item.offsetHeight)).element.scrollTo(0, o.options),
                        hn({
                            qn: !1
                        }),
                        V(t),
    ...
    function lo(n) {
        ...
        2 == n.which && (t = n.pageY,
        Ai = t,
        St().addEventListener("mousemove", xi))
    }
    function co(n) {
    ...
    function fo(n) {
        ...
        function() {
            if (Ci.Gn && (a || l)) {
                ...
                n.removeEventListener(Ci.Gn, Ii, {
                    passive: !1
                }),
                n.addEventListener(Ci.Yn, Bi),
                n.addEventListener(Ci.Gn, Ii, {
                    passive: !1
                })
            }
        }()) : (ao(!1),
    ...
    function po(n) {
        ...
        i != document && i ? ("touchend" === t && (so = !1,
        setTimeout((function() {
            so = !0
        }
        ), 800)),
        ("mouseenter" !== t || so) && (Tt().normalScrollElements.split(",").forEach((function(n) {
            if (!e) {
                var t = Q(i, n)
                  , o = C(i, n);
                (t || o) && (f.shared.Jn || fo(!1),
                f.shared.Jn = !0,
                e = !0)
            }
        }
    ...
    function Mo() {
        ...
        mo = setTimeout((function() {
            !function() {
                ...
                xo(""),
                Tt().autoScrolling || dn.B || function() {
                    if (!Tt().autoScrolling || Tt().scrollBar) {
                ...
                a) {
                    ...
                    if (!Q(n, "textarea") && !Q(n, "input") && !Q(n, "select")) {
                        var t = w();
                        Math.abs(t - bo) > 20 * Math.max(bo, t) / 100 && (Ao(!0),
                        bo = t)
                    }
                } else
                    e = w(),
    ...
    function Do(n) {
        ...
        !p(Tt().menu)[0] || !Tt().lockAnchors && Tt().anchors.length || (V(n),
        vn.R(jn, {
    ...
    function zo(n) {
        var t, e, i, o, r;
        if (!dn.V && pn().I && (rn(pn().C),
        !pn().B && !pn().qn && (!Tt().autoScrolling || Tt().scrollBar))) {
            var a = H()
              , u = function(n) {
                var t = n > Fo ? "down" : "up";
                return Fo = n,
            ...
            r = o + w(),
            ("up" == i ? r >= H() + w() : o <= H()) && (m(pn().I.item, Gn) || (L(pn().I.item, Gn),
            D(W(pn().I.item), Gn))),
            e = (t = s[l]).item,
            !t.isActive) {
                hn({
                ...
                var d, h, p = pn().I.item, g = pn().I.index() + 1, b = Nt(pn().I, e), y = t.anchor, S = t.index() + 1, T = t.activeSlide, M = {
                    I: p,
                    sectionIndex: S - 1,
                    anchorLink: y,
                    element: e,
            ...
            Tt().fitToSection && dn.G && (clearTimeout(Po),
    ...
    function Co(n, t) {
        ...
        Tt().keyboardScrolling = n)
    }
    function Io(n) {
        var t = n.index();
        void 0 !== Tt().anchors[t] && n.isActive && we(Tt().anchors[t], t),
        Tt().menu && Tt().css3 && null != C(p(Tt().menu)[0], Hn) && p(Tt().menu).forEach((function(n) {
            Kt.appendChild(n)
        }
        ))
    }
    function No() {
        ...
        Jt(i),
        t = qi((n = ko()).section),
        n.section && t && (void 0 === t || t.index() !== A(Ce)) || !Y(Tt().afterLoad) || Xt("afterLoad", {
            I: i,
            element: i,
            direction: null,
            anchorLink: e.anchor,
    ...
    function Vo() {
        var n = Tt().licenseKey;
        "" === Tt().licenseKey.trim() ? (v("error", "Fullpage.js requires a `licenseKey` option. Read about it on the following URL:"),
        v("error", "https://github.com/alvarotrigo/fullPage.js#options")) : Tt() && dn.nt || r.domain.indexOf("alvarotrigo.com") > -1 ? n && n.length : (v("error", "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"),
        v("error", "https://alvarotrigo.com/fullPage/pricing")),
        m(qt, _n) ? v("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (Tt().continuousVertical && (Tt().loopTop || Tt().loopBottom) && (Tt().continuousVertical = !1,
        v("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
        !Tt().scrollOverflow || !Tt().scrollBar && Tt().autoScrolling || v("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"),
        !Tt().continuousVertical || !Tt().scrollBar && Tt().autoScrolling || (Tt().continuousVertical = !1,
        v("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")),
    ...
    function() {
        vn.D(yn, (function() {
            ...
            hn({
                ...
                (u || l) && (u && e <= u.et && u.ot === t.split(n[0])[4] || l || u.it) || !1)
            })
        }
        ));
        var n = ["-"]
